...
void addressBookExternalChangeCallback(ABAddressBookRef addressBookRef, CFDictionaryRef info, void *context)
{
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:@"VIAddressBookKit.AddressBookDidChangeExternallyNotification" object:(__bridge id)context]; // TODO: use global constant from swift code as notification name
    });
}
